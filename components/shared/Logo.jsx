      ...
      <a className={cls.root}>
        <svg className={cls.svg} width="38" height="38" viewBox="0 0 38 38" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clipLogo)">
            ...
            <path d="M4.60671 37.9999L0.00195312 33.6172L2.87763 30.5037L0.68343 28.4967L15.1344 22.7766L9.78458 36.8466L7.52395 34.8416L4.60671 37.9999Z" fill="#2A2A2A"/>
            <path d="M4.60686 37.9999L2.20068 35.7097L15.1346 22.7766L9.78473 36.8466L7.5241 34.8416L4.60686 37.9999Z" fill="#151515"/>
        ...
        <span className={cls.subTitle}>Dating Solutions</span>
      </a>
    </Link>
  )
}